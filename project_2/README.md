...
```
project_2/
├── StudentsPerformance.csv            # Raw dataset (1,000 student records, 8 columns)
├── StudentsPerformanceAnalysis.ipynb   # Main analysis notebook
...
```bash
jupyter notebook StudentsPerformanceAnalysis.ipynb
```
